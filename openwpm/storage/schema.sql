...
CREATE TABLE
    IF NOT EXISTS responses_content(
...
CREATE TABLE
    IF NOT EXISTS javascript_cookies(
...
CREATE TABLE
    IF NOT EXISTS incomplete_visits (visit_id INTEGER NOT NULL);
